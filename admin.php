...
<head>
    ...
    <title>Admin - Sistema de Agendamentos</title>
        ...
        <div class="container">
            ...
            <div class="card-section">
                ...
                ?>
                    ...
                    <button type="submit" name="cancelar_agendamento" class="btn-cancel"
                        onclick="return confirm('Tem certeza que deseja cancelar os agendamentos selecionados?');">Cancelar
                        Selecionados</button>
                </form>
                <script>
            ...
            <div class="card-section">
                ...
                <form method="post" id="form-utilizadores">
                    <div class="table-responsive">
                        <table>
                            <thead>
                                <tr>
